...
function Project(props) {
  ...
  function renderFeatures() {
    ...
    if (features.length !== undefined)
      return features.map(feat => <li>{feat}</li>);
        ...
        <div className="reference-btns-container">
          {props.project.projectUrl ? (
            <a
              ...
              target="_blank"
            >
              <FaDiceD6 className="contact-icons" />{" "}
              {translation[props.language].linkProject}
            </a>
          ) : (
            <a className="reference-btn reference-btn-not-available">
              <FaDiceD6 className="contact-icons" />{" "}
              {translation[props.language].notAvailable}
            </a>
          )}
          {props.project.codeUrl ? (
            <a
              ...
              target="_blank"
            >
              <FaCode className="contact-icons" />{" "}
              {translation[props.language].linkCode}
            </a>
          ) : (
            <a className="reference-btn reference-btn-not-available">
              <FaCode className="contact-icons" />{" "}
